...
namespace Shared.Utilities.Tests.Serialization
{
	...
	public class BinarySerializationProviderTests
	{
		...
		{
			CommonSerializationProviderTests.Serialize_ObjectNull(new BinarySerializationProvider());
		}
		...
		{
			CommonSerializationProviderTests.Serialize_StreamNull(new BinarySerializationProvider());
		}
		...
		{
			CommonSerializationProviderTests.Serialize_NonSerializableObject(new BinarySerializationProvider());
		}
		...
		{
			CommonSerializationProviderTests.Serialize_SerializableObjectToBuffer(new BinarySerializationProvider());
		}
		...
		{
			CommonSerializationProviderTests.Serialize_SerializableObjectToStream(new BinarySerializationProvider());
		}
		...
		{
			CommonSerializationProviderTests.Serialize_SerializableObjectToNonWritableStream(new BinarySerializationProvider());
		}
		...
		{
			CommonSerializationProviderTests.Deserialize_BufferNullOrEmpty(new BinarySerializationProvider());
		}
		...
		{
			CommonSerializationProviderTests.Deserialize_StreamNull(new BinarySerializationProvider());
		}
		...
		{
			CommonSerializationProviderTests.Deserialize_StreamNonReadable(new BinarySerializationProvider());
		}
		...
		{
			CommonSerializationProviderTests.Deserialize_TypeMismatch(new BinarySerializationProvider(), _preSerializedBuffer);
		}
		...
		{
			CommonSerializationProviderTests.Deserialize_DeserializeSerializableObject(new BinarySerializationProvider(), _preSerializedBuffer);
		}
		...
		{
			CommonSerializationProviderTests.Deserialize_DeserializeFromStream(new BinarySerializationProvider(), _preSerializedBuffer);
		}
		...
		{
			CommonSerializationProviderTests.UnderlyingSerializer_IsOfCorrectType<BinaryFormatter>(new BinarySerializationProvider());
		}
		...
		public void RoundTrip_SerializeObject()
		{
			...
			CommonSerializationProviderTests.RoundTrip_SerializeObject(new BinarySerializationProvider(), obj);
		}
